...
class LorentzFit : public MultiPeakFit
{
	...
	public:
		LorentzFit(ApplicationWindow *parent, PlotCurve *);
		LorentzFit(ApplicationWindow *parent, PlotCurve *, double, double);
...
class GaussFit : public MultiPeakFit
{
	...
	public:
		GaussFit(ApplicationWindow *parent, PlotCurve *);
		GaussFit(ApplicationWindow *parent, PlotCurve *, double, double);
