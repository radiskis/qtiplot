...
class SigmoidalFit : public Fit
{
	...
	public:
		SigmoidalFit(ApplicationWindow *parent, PlotCurve *);
		SigmoidalFit(ApplicationWindow *parent, PlotCurve *, double, double);
		SigmoidalFit(ApplicationWindow *parent, Graph *g = nullptr);
