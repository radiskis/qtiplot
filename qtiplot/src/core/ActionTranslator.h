...
#ifndef ACTION_TRANSLATOR_H
#define ACTION_TRANSLATOR_H
...
{
public:
    static void translateActionsStrings(ApplicationWindow *app);
};

#endif // ACTION_TRANSLATOR_H
