    ...
    : QDialog(parent, fl)
{
	...
	connect(buttonRemove, &QAbstractButton::clicked, this, &CustomActionDialog::removeAction);
	connect(buttonCancel, &QAbstractButton::clicked, this, &CustomActionDialog::reject);
