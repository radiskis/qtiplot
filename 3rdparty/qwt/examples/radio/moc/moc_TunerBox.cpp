...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TunerBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TunerBox_t qt_meta_stringdata_TunerBox = {
    {
QT_MOC_LITERAL(0, 0, 8), // "TunerBox"
QT_MOC_LITERAL(1, 9, 12), // "fieldChanged"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 1), // "f"
QT_MOC_LITERAL(4, 25, 7), // "setFreq"
QT_MOC_LITERAL(5, 33, 3), // "frq"
QT_MOC_LITERAL(6, 37, 10) // "adjustFreq"

    },
    "TunerBox\0fieldChanged\0\0f\0setFreq\0frq\0"
    "adjustFreq"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_TunerBox[] = {
...
void TunerBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TunerBox::fieldChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TunerBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_meta_stringdata_TunerBox.data,
