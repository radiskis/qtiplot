...
ae_bool spchol_updatekernelabc4_avx2(ae_vector* _rowstorage,
     ...
     ae_state *_state)
{
    double* __restrict rowstorage           = _rowstorage->ptr.p_double;
    double* __restrict diagd                = _diagd->ptr.p_double;
    const ae_int_t* __restrict raw2smap     = _raw2smap->ptr.p_int;
    const ae_int_t* __restrict superrowidx  = _superrowidx->ptr.p_int;
    ae_int_t k;
    ae_int_t targetrow;
    ae_int_t targetcol;
