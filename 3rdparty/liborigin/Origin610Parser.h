/***************************************************************************
	File                 : Origin610Parser.h
    --------------------------------------------------------------------
	Copyright            : (C) 2010 Ion Vasilief
	Email (use @ for *)  : ion_vasilief*yahoo.fr
	Description          : Origin 6.1 file parser class
...
#ifndef ORIGIN_610_PARSER_H
#define ORIGIN_610_PARSER_H

#include "Origin800Parser.h"

class Origin610Parser : public Origin800Parser
{
public:
